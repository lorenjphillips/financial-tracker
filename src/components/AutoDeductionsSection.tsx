...
const AutoDeductionsSection: React.FC<AutoDeductionsSectionProps> = React.memo(({
  ...
  <div className="mb-6">
    ...
    <div className="bg-blue-50 p-3 text-sm text-blue-900 border-b">
    ...
    {Object.entries(automaticDeductions).map(([key, data]) => (
      <div key={`deduction-${key}`} className="border-b hover:bg-gray-50">
        <div className="grid grid-cols-12 gap-2 p-3">
          ...
          <div className="col-span-5">
            <input
              ...
              className="w-full px-2 py-1 text-sm border rounded text-gray-900 font-medium"
